(() => {
  ...
  document.querySelectorAll(
    '.attemptResults .answer-preview[data-bs-toggle="popover"]',
  )
    .forEach((preview) => {
  ...
  const session = document.getElementById("sessionJWT")?.value;
  if (score) {
  ...
  document.querySelectorAll('.knowl[data-type="solution"]').forEach(
    (solution) => {
  ...
  function processMessageQueue() {
    ...
    for (
      let message = messageQueue.pop(); message; message = messageQueue.pop()
    ) {
