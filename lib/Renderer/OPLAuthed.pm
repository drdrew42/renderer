...
# signature-check prelude is identical: has-public-key, X-Telemetry-
# Signature header presence, Ed25519 verify, JSON body parse. Only the
# downstream concurrency guards and action bodies differ.
#
# Usage:
#
