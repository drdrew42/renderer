...
$nextBlock = <<'ENDPROBLEMTEMPLATE';
<!-- CSS Loads -->
<link rel="stylesheet" type="text/css" href="$webwork_htdocs_url/js/vendor/bootstrap/css/bootstrap.css"/>
<link rel="stylesheet" type="text/css" href="$webwork_htdocs_url/js/vendor/bootstrap/css/bootstrap-responsive.css"/>
<link rel="stylesheet" type="text/css" href="$webwork_htdocs_url/css/jquery-ui-1.8.18.custom.css"/>
<link rel="stylesheet" type="text/css" href="$webwork_htdocs_url/css/vendor/font-awesome/css/font-awesome.min.css"/>
...
<script type="text/javascript" src="$webwork_htdocs_url/mathjax/MathJax.js?config=TeX-MML-AM_HTMLorMML-full"></script>
<script type="text/javascript" src="$webwork_htdocs_url/js/jquery-ui-1.9.0.js"></script>
<script type="text/javascript" src="$webwork_htdocs_url/js/vendor/bootstrap/js/bootstrap.js"></script>
...
<script type="text/javascript" src="$webwork_htdocs_url/js/vendor/underscore/underscore.js"></script>
<script type="text/javascript" src="$webwork_htdocs_url/js/legacy/vendor/knowl.js"></script>
<script type="text/javascript" src="$webwork_htdocs_url/js/apps/Problem/problem.js"></script>
